...
Questions = open("fullNasalCancerFixed.ASC", 'r')
unweightedData = open("unweightedNasalCancerWithDiagsAndProcsAll.csv", 'w')
...
#THIS FILTERS SO JUST LINES THAT ARE 160.X
...
for line in Questions:
    ...
    if(int(year) <= 1992 or int(year) >= 1998):
        ...
        for i in range(0, 15 - (len(diagnoses)/5)):
            diags = diags + ","
